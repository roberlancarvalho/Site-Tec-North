(function ($) {
    ...
    $.ajaxChimp = {
        responses: {
            'Enviámos um e-mail de confirmação': 0,
            ...
            'A parte do nome de usuário do endereço de e-mail é inválida (a parte antes da @: )': 4,
        ...
        $(this).each(function (i, elem) {
            ...
            form.submit(function () {
                ...
                function successCallback(resp) {
                    if (resp.result === 'successo') {
                        msg = 'Enviámos um email de confirmação';
